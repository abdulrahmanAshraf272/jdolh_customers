...
class AddResInvitorsScreen extends StatelessWidget {
  const AddResInvitorsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(AddResInvitorsController());
    return Scaffold(
        ...
        body: GetBuilder<AddResInvitorsController>(
