...
import 'package:jdolh_customers/controller/occasion/add_to_occasion_created_controller.dart';
...
class AddToOccasionCreatedScreen extends StatelessWidget {
  const AddToOccasionCreatedScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(AddToOccasionCreatedController());
    return Scaffold(
        appBar: customAppBar(title: 'أضف للمناسبة'),
        body: GetBuilder<AddToOccasionCreatedController>(
